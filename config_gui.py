...
"}")
        ...
        self.gridLayout_6.addWidget(self.spinBistInterval, 2, 1, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.spinCriticalMemory, 1, 1, 1, 1)
        ...
        self.ckImageMirrored = QtWidgets.QCheckBox(self.groupBox_3)
        self.ckImageMirrored.setObjectName("ckImageMirrored")
        self.gridLayout_6.addWidget(self.ckImageMirrored, 0, 0, 1, 2)
