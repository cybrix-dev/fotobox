...
"}")
        ...
        self.groupBox_4 = QtWidgets.QGroupBox(self.system)
        self.groupBox_4.setObjectName("groupBox_4")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.groupBox_4)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.ckImageMirrored = QtWidgets.QCheckBox(self.groupBox_4)
        self.ckImageMirrored.setObjectName("ckImageMirrored")
        self.gridLayout_7.addWidget(self.ckImageMirrored, 0, 0, 1, 1)
        self.spinKnobResize = QtWidgets.QDoubleSpinBox(self.groupBox_4)
        ...
        self.gridLayout_7.addWidget(self.spinKnobResize, 0, 2, 1, 1)
        self.label_9 = QtWidgets.QLabel(self.groupBox_4)
        self.label_9.setObjectName("label_9")
        self.gridLayout_7.addWidget(self.label_9, 0, 1, 1, 1)
        self.spinKnobIcon = QtWidgets.QDoubleSpinBox(self.groupBox_4)
        self.spinKnobIcon.setProperty("value", 0.75)
        self.spinKnobIcon.setObjectName("spinKnobIcon")
        self.gridLayout_7.addWidget(self.spinKnobIcon, 1, 2, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_4.setTitle(_translate("Dialog", "Gui"))
